...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 11:29:30 2025

@author: Qishuo

Double Deep Learning: Causal Forest (CF) only on latent factors and throughout for ATE estimator
...
path_inner_ATE = 'factor_CF_ATE_hat.csv'
path_inner_ATE_ci_low = 'factor_CF_ATE_ci_low.csv'
path_inner_ATE_ci_up = 'factor_CF_ATE_ci_up.csv'
path_inner_MSE = 'factor_CF_MSE.csv'
path_inner_ATE_ci_low_mean = 'factor_CF_ATE_ci_low_mean.csv'
path_inner_ATE_ci_up_mean = 'factor_CF_ATE_ci_up_mean.csv'
path_inner_coverage = 'factor_CF_coverage.csv'
