...
Double Deep Learning: data generate 
...
def generate_propensity(f, u):
    pi = 1 / (1 + np.exp(-( np.sin(f[:, 0]) + np.tan(f[:, 1]) + f[:, 2] + f[:, 3] + u[:, 0] + u[:, 1] + u[:, 2] + u[:, 3] + u[:, 4] )))  # treatment assignment with size (n, )
    return pi


# generate covaraite effect
def generate_covariate_effect(f, u):
    mu = 10 + f[:, 0] + f[:, 1]*f[:, 2] + np.sin(f[:, 3]) + np.log(5 + u[:, 0] + u[:, 1] * u[:, 2]) + np.tan(u[:, 3]) + u[: ,4]
    return mu


# generate treatment effect
def generate_treatment_effect(f, u):
    tau = 5 + f[:, 0] + f[:, 1] + np.sin(f[:, 2]) + np.tan(f[:, 3]) + u[:, 0] + u[:, 1] + np.sin(u[:, 2] + u[:, 3]) + np.tan(u[: ,4])
    return tau
...
# n_vec = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000] # size of dataset
n_vec = [6000, 7000, 8000, 9000, 10000] # size of dataset
# n_vec = [100, 500, 1000, 2000, 5000] # size of dataset
=======
n_vec = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000] # size of dataset
>>>>>>> 97d9749e92cdb20eabcb79927c257e802a8d1038
