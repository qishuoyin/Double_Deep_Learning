...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 14 16:40:43 2025

@author: Qishuo

Double Deep Learning: script to run ATE estimation by Double Machine Learning (DML) estimator only on latent factors and throughout for application
...
path_inner_final_results = 'factor_DML_final_results.csv'
