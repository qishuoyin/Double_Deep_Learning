...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 14 16:47:08 2025

@author: Qishuo

Double Deep Learning: script to run ATE estimation by Double Robust (DR) estimator for application
...
path_inner_final_results = 'factor_DR_final_results.csv'
