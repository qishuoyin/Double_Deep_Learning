...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 14 16:33:21 2025

@author: Qishuo

Double Deep Learning: script to run ATE estimation by Causal Forest (CF) only on latent factors and throughout for application
...
path_inner_final_results = 'factor_CF_final_results.csv'
