...
class NNModelTrain:
    ...
    def fit(self, dataloader_train, dataloader_val, logistic, regularization_type=None, lambda_reg=1, penalty_weight=None, tau0=0.005, dataloader_test=None, stop=False):
